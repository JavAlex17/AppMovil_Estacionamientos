...
class RegistroReservasPage extends StatefulWidget {
  @override
  _RegistroReservasPageState createState() => _RegistroReservasPageState();
}

class _RegistroReservasPageState extends State<RegistroReservasPage> {
  Future<List<Map<String, dynamic>>> _getReservasUsuario() async {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        subtitle: Text('Fecha: $formattedFecha\nHora: $horaInicio a $horaFin\nPatente: $patente\nLugar: $lugar\nCampus: $campus\nActiva: ${activa ? "Sí" : "No"}', style: TextStyle(fontSize: 16)),
                      );
                    },
                  );
                }
