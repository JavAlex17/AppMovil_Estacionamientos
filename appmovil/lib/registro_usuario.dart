...
class _RegisterFormState extends State<RegisterForm> {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('Registro de Usuarios', style: TextStyle(fontSize: 28, color: Color(0xFF000000))),
  ...
  Future<void> _register() async {
    ...
    if (!email.endsWith('@alumnos.ulagos.cl') && !email.endsWith('@ulagos.cl')) {
      _showErrorDialog('Por favor, use un correo electrónico institucional');
      return;
    }
    ...
    try {
      ...
      if (user != null) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const UsuarioPage()), // Reemplaza con tu página de usuario
        );
      }
    } catch (e) {
